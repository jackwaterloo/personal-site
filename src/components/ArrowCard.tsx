  ...
  return (
    ...
    >
      <div class="blend w-full group-hover:text-black group-hover:dark:text-white">
        ...
        <div class="mt-3 line-clamp-2 font-semibold text-black dark:text-white">
          {entry.data.title}
        </div>
        ...
        <ul class="mt-2 flex flex-wrap gap-1">
          {entry.data.tags.map(
            (
              ...
              <li class="rounded bg-black/5 px-2 py-0.5 text-xs uppercase text-black/75 dark:bg-white/20 dark:text-white/75">
                {truncateText(tag, 20)}
              </li>
            ),
          )}
